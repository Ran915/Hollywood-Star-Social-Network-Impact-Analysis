---
title: "Hollywood Star Social Network Impact Analysis Report"
author: "Xinran Tao"
date: "2/26/2018"
output: html_document
---

The data is extracted from https://aminer.org/data-sna#Movie. This dataset consists of an actor-director-writer network and relationship between them.

Firstly, we will explore the dataset and clean the data
```{r}
library(igraph) 
library(network)
...
Plot the Actor-Director-Writer network graph
```{r}
library(sna)
...
##### Our question:How does actors/actress' social network relate to their success? 
We created two list of actors&actresses
```{r}
...
We will expolre Actor-Actor relations, Actor-Director relations and Actor-Writer relations.
Compare the two star lists in these relations and see what makes them different.

### 1.Analyze Actor-Actor relationship
In this part we will rank the most socialble actors by centrality and compare the sociability of oscar winners, famous stars and the actors population
```{r}
detach(package:sna)
...
```
From the summary, we can see oscar winners have higher average degree centrality, higher average betweenness centrality, and higher closeness centrality compared to famous stars, and famous stars all have higher centrality compared to average centrality of all the stars


### 2.Analyze Actor-Director relationship
In this part, we will explore the relationship between actors and directors, and rank the actors by the number of directors
they know. We will also compare the oscar winners, famous stars and the actors population
```{r}
...
```
From the summary, we can see oscar winners know average more directors than famous stars,and famous stars know more directors than the population


### 3.Analyze Actor-Writer relationship
In this part, we will explore the relationship between actors and writers,and rank the actors by the number of writers
they know. We will also compare the two star lists.
```{r}
...
```
From the summary, we can see oscar winners know average more writers than famous stars,and famous stars know more writers than the population
######from the analysis above, we can see oscar winning actors/actress have generally more connections  
######with their peer actors/actress, directors and writers compared to other famous actors/actress


######In the next two part we will select a list of most authoritative directors and writers according 
######to their sociability and see their impact on the stars

###4.Analyze directors network
In this part we will rank the most authoritative directors by centrality in the full network
```{r}
...
In this part we will rank the most authoritative writers by centrality in the full network
```{r}
...
We can see oscar winners know averge more authoritative directors/writers than famous stars, famous stars know averge more authoritative directors/writers than the all the actors
